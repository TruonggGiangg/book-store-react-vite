...
import { Button, Drawer, Form, GetProp, Input, notification, Select, Space, Upload, UploadFile, UploadProps } from "antd"
...
const CategoryCreate = (props: IProps) => {
    ...
    const onFinish = async (values: ICreateCategory) => {
        ...
        const category: ICreateCategory = {
            ...
            image: Array.isArray(values.image) && values.image.length > 0
