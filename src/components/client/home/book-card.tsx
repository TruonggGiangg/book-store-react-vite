...
const BookCard: FC<BookCardProps> = ({ book, gridSizes, listCategories, isBook = false, showRibbon = false, ribbonText = "HOT", ribbonColor = "red" }) => {
                ...
                description={
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                        ...
                        <Space align="center" style={{ display: "flex" }}>
                            <InputNumber min={1} defaultValue={1} size="small" style={{ padding: "6px", width: "100%" }} />
                            <Button type="primary" icon={<ShoppingCartOutlined />} style={{ background: "#FF5733", borderColor: "#FF5733", flex: 2 }}>
                                Add to cart
                            </Button>
                        </Space>
                    </div>
