...
const ListCardSkeleton = lazy(
  () => import("@/components/client/home/skeleton")
);
...
const BookDetailPage = () => {
    ...
    const fetchSuggestedBooks = async () => {
      ...
      try {
        ...
        if (res.data && res.data.result) {
          setSuggestedBooks(
            res.data.result.filter((b: IGetBook) => b._id !== id)
          );
        }
      } catch (error) {
  ...
  useEffect(() => {
    const fetchHotTools = async () => {
      ...
      try {
        const hotTools = await getAllBookApi(
          "current=1&pageSize=12&sort=-sold&isBook=false"
        );
    ...
    <div>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={24} md={6}>
          <div
            style={{ position: "sticky", top: "100px", marginBottom: "24px" }}
          >
            <Card
              style={{
                borderRadius: "8px",
                    ...
                    >
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: book.description || "<p>Không có mô tả.</p>",
                        }}
                      />
                    </Card>
                  </Col>
                      ...
                      >
                        ...
                        <Panel
                          header={
                            <Space>
                              <InfoCircleOutlined />
                              <Text strong>Hướng dẫn sử dụng sản phẩm</Text>
                            </Space>
                          }
                          key="4"
                          style={{ borderBottom: "1px solid #E8E8E8" }}
