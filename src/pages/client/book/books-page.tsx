...
import { Button, Card, Checkbox, Collapse, InputNumber, Row, Select, Slider, Typography } from 'antd';
            ...
            <Container>
                ...
                <Collapse
                    ...
                    items={[
                        {
                            key: '1',
                            label: <Text style={{ fontWeight: 600, color: "#ff5733", fontSize: "1.6rem" }}>Bộ lọc sách</Text>,
