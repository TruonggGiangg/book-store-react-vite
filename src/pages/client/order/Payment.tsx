    ...
    const onFinish = async () => {
        try {
            if (currentStep === 0) {
                ...
                console.log('Step 2 values:', { name, phone, province, district, ward, address });
                setCurrentStep(2);
                ...
                try {
                    ...
                    const provinceName = provinces.find((p) => String(p.code) === String(province))?.name || 'Chưa chọn';
                    const districtName = districts.find((d) => String(d.code) === String(district))?.name || 'Chưa chọn';
                    const wardName = wards.find((w) => String(w.code) === String(ward))?.name || 'Chưa chọn';

                    if (address === '' || wardName === 'Chưa chọn' || districtName === 'Chưa chọn' || provinceName === 'Chưa chọn') {
            ...
            content: (
                <Card title="Địa chỉ giao hàng">
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        <div>
                            <label style={{ display: 'block', marginBottom: 8 }}>Họ và tên <span style={{ color: 'red' }}>*</span></label>
                            <Input
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: 8 }}>Số điện thoại <span style={{ color: 'red' }}>*</span></label>
                            <Input
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: 8 }}>Tỉnh/Thành <span style={{ color: 'red' }}>*</span></label>
                            <Select
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: 8 }}>Quận/Huyện <span style={{ color: 'red' }}>*</span></label>
                            <Select
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: 8 }}>Phường/Xã <span style={{ color: 'red' }}>*</span></label>
                            <Select
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: 8 }}>Địa chỉ chi tiết <span style={{ color: 'red' }}>*</span></label>
                            <Input.TextArea
        ...
        },
        {
            ...
            content: (
                <Card title="Hình thức thanh toán">
                    ...
                    <Card title={<Title level={4}>📍 Địa chỉ giao hàng</Title>} style={{ marginTop: 24, borderRadius: 12 }}>
                        <Descriptions bordered column={1}>
                            <Descriptions.Item label="Họ và tên">{name || 'Chưa nhập'}</Descriptions.Item>
                            <Descriptions.Item label="Số điện thoại">{phone || 'Chưa nhập'}</Descriptions.Item>
